...
<head>
    <style>
        ...
        .print
        {
            ...
            color: #fff;
            z-index: 300;
            background-image: url('../theme/img/print_icon.png');
    ...
    <title>Superlanger Fotobox</title>
    <meta charset="utf-8">
...
$dir    = '../images/original/';
$files = glob($dir.'[0-9][0-9][0-9][0-9][0-9][0-9]_[0-9][0-9][0-9][0-9][0-9][0-9].{jpg, JPG, jpeg, JPEG}', GLOB_BRACE);
...
<div style="min-height: 100%; max-height: 100%;">
    ...
    <a href="javascript:reprint()"><div class="printwrapp">
            <div class="print"></div>
            <div class="printdesc">Nochmal Drucken</div>
        </div>
    </a>
