;(function ($, window, document, undefined) {
  ...
  Foundation.libs.clearing = {
    ...
    settings : {
      ...
      close_selectors : '.close, div.clearing-blackout',
    ...
    assemble : function ($li) {
      ...
      if (grid[0] == null) {
        ...
        var holder = this.S('#foundationClearingHolder'),
          ...
          wrapper = '<div class="clearing-assembled"><div>' +
              '<div class="menu" style="display: none;important;">' +
               '<a href="#" class="close button expand">Zurück</a>' +
              '<a href="#" onclick="return reprint();" class="button expand">Drucken</a>' +
              '</div>' + data.viewing +
            data.grid + '</div></div>',
